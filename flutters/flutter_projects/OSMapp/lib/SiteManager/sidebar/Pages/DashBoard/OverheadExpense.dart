...
import 'package:osm_app/SiteManager/sidebar/Pages/DashBoard/FormCardBillPhoto.dart';
import 'package:osm_app/SiteManager/sidebar/Pages/DashBoard/OverheadExpensesContent.dart';
...
class OverheadExpense extends StatefulWidget with NavigationStates {
  final id,name,sitename,siteId;

  OverheadExpense(this.id,this.name,this.sitename,this.siteId);

  @override
  _OverheadExpenseState createState() => _OverheadExpenseState();
}

class _OverheadExpenseState extends State<OverheadExpense> {
  ...
  Widget getbody() {
    return SingleChildScrollView(
      child: Card(
        child: Column(
          children: <Widget>[
            OverHeadExpensesContent(widget.id,widget.name,widget.sitename,widget.siteId),
          ],
        ),
      ),
    );
