...
class BillPhoto extends StatefulWidget with NavigationStates {
  final id,name,sitename,siteId;

  BillPhoto(this.id,this.name,this.sitename,this.siteId);

  @override
  _BillPhotoState createState() => _BillPhotoState();
}

class _BillPhotoState extends State<BillPhoto> {
  ...
  Widget getbody() {
    return SingleChildScrollView(
      child: Card(
        child: Column(
          children: <Widget>[
            FormCardBillPhoto(widget.id,widget.name,widget.sitename,widget.siteId),
          ],
        ),
      ),
    );
