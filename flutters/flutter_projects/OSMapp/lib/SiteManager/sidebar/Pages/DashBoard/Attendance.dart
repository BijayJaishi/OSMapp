...
import 'package:osm_app/SiteManager/sidebar/Pages/DashBoard/FormCardAttendance.dart';
...
class Attendance extends StatefulWidget with NavigationStates {
  final id,name,sitename,siteId;

  Attendance(this.id,this.name,this.sitename,this.siteId);
  @override
...
class _AttendanceState extends State<Attendance> {
  ...
  Widget getbody() {
    ...
    return FormCardAttendance(widget.id,widget.name,widget.sitename,widget.siteId);
...
//            Column(
//              children: <Widget>[
//                FormCardAttendance(widget.id,widget.name,widget.sitename,widget.siteId),
//              ],
//            ),
//          ],
//
