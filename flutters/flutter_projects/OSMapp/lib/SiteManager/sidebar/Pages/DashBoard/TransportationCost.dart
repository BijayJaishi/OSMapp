...
import 'package:osm_app/SiteManager/sidebar/Pages/DashBoard/FormCardTrandportationCost.dart';
...
class TransportationCostManager extends StatefulWidget with NavigationStates {

  final id,name,sitename,siteId;

  TransportationCostManager(this.id,this.name,this.sitename,this.siteId);

  @override
  _TransportationCostManagerState createState() => _TransportationCostManagerState();
}

class _TransportationCostManagerState extends State<TransportationCostManager> {
  ...
  Widget getbody() {
    return SingleChildScrollView(
      child: Card(
        child: Column(
          children: <Widget>[
            FormCardTransportatonCost(widget.id,widget.name,widget.sitename,widget.siteId),
          ],
        ),
      ),
    );
