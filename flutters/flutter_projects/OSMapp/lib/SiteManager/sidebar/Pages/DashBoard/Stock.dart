...
import 'package:osm_app/SiteManager/sidebar/Pages/DashBoard/FormCardStock.dart';
...
class Stock extends StatefulWidget with NavigationStates {
  final id,name,sitename,siteId;

  Stock(this.id,this.name,this.sitename,this.siteId);
  @override
...
class _StockState extends State<Stock> {
  ...
  Widget getbody() {
    ...
    return FormCardStock(widget.siteId);
//    return Card(
//      child: Wrap(
//        children: <Widget>[
//           Column(
//            children: <Widget>[
//              FormCardStock(widget.siteId),
//            ],
//          ),
//        ],
//
