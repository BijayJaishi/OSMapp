...
import 'TransportationCostContent.dart';

class TransportationCost extends StatefulWidget {
  final uId;

  TransportationCost(this.uId);

  @override
  TransportationCostState createState() => new TransportationCostState();
}
          ...
          return [
            SliverAppBar(
              ...
              flexibleSpace: new FlexibleSpaceBar(centerTitle: true,
                ...
                title: new Text("Transportation Cost",
                    style: TextStyle(
                      color: Colors.black,
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        Positioned(
          ...
          right: 0,
          top: 0,
          child: transportationcostcontent(widget.uId),
        )
      ],
    );
  }
