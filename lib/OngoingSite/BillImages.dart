...
import 'package:osm_app/model_classes/site_bill_list.dart';
...
class _BillImagesState extends State<BillImages> {
  ...
  _fetchListItem() async {
    String dataURL = "http://halfwaiter.com/stock/api/request/siteBill/?id=1";
              ...
              children: <Widget>[
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ImageDialogbox("http://halfwaiter.com/stock/assets/uploads/bill/$imgUrl");
                    },
                    child: Container(
                      child: GestureDetector(
                        child: PhotoView(
                          ...
                          imageProvider: NetworkImage("http://halfwaiter.com/stock/assets/uploads/bill/$imgUrl"),
