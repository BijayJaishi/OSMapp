 ...
 */
public class Academic extends Fragment implements ViewPager.OnPageChangeListener,TabHost.OnTabChangeListener{
    ...
    private void initViewPager() {
        ...
        fragmentList.add(new PlusTwoFragment());
        fragmentList.add(new BachelorFragment());
        fragmentList.add(new MastersFragment());
