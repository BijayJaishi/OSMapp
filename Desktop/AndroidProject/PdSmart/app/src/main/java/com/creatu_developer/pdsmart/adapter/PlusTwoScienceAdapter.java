...
public class PlusTwoScienceAdapter extends RecyclerView.Adapter<PlusTwoScienceAdapter.MyViewHolder> {

    Context context;
    List<CompetitiveCourseModelClass> competitiveCourseModelClassList;

    public PlusTwoScienceAdapter(Context context, List<CompetitiveCourseModelClass> competitiveCourseModelClassList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PlusTwoScienceAdapter.MyViewHolder holder, int position) {
